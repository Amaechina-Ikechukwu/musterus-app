                    ...
                    <View style={{
                        ...
                        <View style={{ width: '100%', }}>
                            <ImageBackground
                                ...
                                src={data && `https://ddhqtepvmjgbfndcjrkn.supabase.co/storage/v1/object/public/${data.img}`}
                            >
                                ...
                                <View style={styles.centeredView}>
                                    <Modal
                                        ...
                                        <Image
                                            ...
                                            src={`https://ddhqtepvmjgbfndcjrkn.supabase.co/storage/v1/object/public/${data && data.img}`}
                                            resizeMode={'cover'} />
                ...
                {reportAccount == true ?
                    ...
                    <ScrollView>
                        <View style={{ marginTop: 10, width: "100%" }} >
                            <Text style={[Style.Text, { textAlign: "center" }]} >Select the campaign you want {User.name} to support. </Text>
                            <Divider style={{ marginTop: 20 }} />
