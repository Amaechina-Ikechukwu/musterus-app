...
export default function BCSEventStack({ appState }) {
    ...
    return (
        ...
        >
            ...
            {/* muster cards ================= */}
            <Stack.Screen name='MuterCards' component={MuterCards} options={{
                header: () => null,
            }} />

            {/* muster cards ================= */}
            <Stack.Screen name='SelectCard' component={SelectCards} options={{
                header: () => null,
            }} />

            {/* muster cards ================= */}
            <Stack.Screen name='Sendto' component={SendTo} options={{
                header: () => null,
            }} />
