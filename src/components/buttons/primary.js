      ...
      <Pressable
        ...
        <Text
          style={[
            ...
            {
              textAlign: 'center',
              color: !titleColor ? Colors.light : titleColor,
            },
          ]}>
          {title}
        </Text>
  ...
  return (
    <>
      {loading && loading == true ? (
        <ActivityIndicator style={{marginVertical: 25}} />
      ) : (
        <TouchableOpacity
          android_ripple={{color: 'white'}}
          onPress={() => {
          ...
          style={[
            {
              backgroundColor:
                noBG && noBG == true ? Colors.light : Colors.primary,
              height: 53,
              width: '90%',
      ...
      {loading && loading == true ? (
        ...
        <Pressable
          ...
          <Text
            style={[
              Style.TextLink,
              {textAlign: 'center', color: textColor && textColor},
            ]}>
            {title}
          </Text>
          {/* <FontAwesomeIcon style={{
  ...
  return (
    <>
      <Pressable
        ...
        <Text style={{textAlign: 'center', fontSize: 12, color: Colors.light}}>
          {title}
        </Text>
        {/* <FontAwesomeIcon style={{
                    flex: 1,
